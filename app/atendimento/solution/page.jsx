...
export default function AtendimentoPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans pb-20">
      ...
      <header className="bg-slate-900 border-b border-slate-800 sticky top-0 z-40 px-6 py-4 shadow-2xl">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
             ...
             <div>
               <h1 className="text-xl font-black tracking-tighter text-white uppercase">{clienteUrl}</h1>
      ...
      {/* PAINEL DE DETALHES PREMIUM (DRAWER) */}
      {selectedLead && (
