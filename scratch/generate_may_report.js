...
async function main() {
  ...
  // Use exact UTC dates to match our normalized database entries (00:00:00.000Z)
  const since = new Date('2026-05-01T00:00:00.000Z');
  const until = new Date('2026-05-31T23:59:59.999Z');

  console.log(`Querying May strictly from ${since.toISOString()} to ${until.toISOString()}`);
