...
async function main() {
  ...
  console.log(`🚀 Sincronizando dados históricos de Maio de 2026 para Solution Place...`);
  ...
  for (const item of campaignData) {
    ...
    if (!camp) continue;
    const dataInsight = new Date(item.date_start + 'T00:00:00.000Z'); // Force UTC midnight during creation
  ...
  console.log(`🎉 Sincronizados ${count} registros para Solution Place em Maio.`);
