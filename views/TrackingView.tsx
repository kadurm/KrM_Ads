  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        {/* CONFIGURAÇÃO DE IDS */}
        <div className="bg-zinc-900 p-8 rounded-[3rem] border border-zinc-800 shadow-2xl space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <input 
                  ...
                  className="w-full bg-zinc-950 border border-zinc-800 rounded-xl p-4 text-sm font-mono text-zinc-300 outline-none"
                />
                <Target size={16} className="absolute right-4 top-4 text-zinc-600" />
              </div>
            </div>

            <div>
              <label className="block text-[10px] font-black text-zinc-500 uppercase mb-2 tracking-widest">Conversions API Token</label>
              <div className="relative">
                <input 
                  type="password" 
                  readOnly
                  ...
                  className="w-full bg-zinc-950 border border-zinc-800 rounded-xl p-4 text-sm font-mono text-zinc-300 outline-none"
                />
                <ShieldCheck size={16} className="absolute right-4 top-4 text-zinc-600" />
              </div>
            </div>
          </div>

          <div className="bg-amber-600/5 p-4 rounded-2xl border border-amber-500/10 flex gap-4">
        ...
        <div className="bg-zinc-900 p-8 rounded-[3rem] border border-zinc-800 shadow-2xl space-y-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-[10px] font-black text-zinc-500 uppercase mb-2 tracking-widest">Test Event Code (Opcional)</label>
              <input 
                type="text" 
                value={testCode}
                onChange={(e) => setTestCode(e.target.value)}
                placeholder="TEST12345"
                className="w-full bg-zinc-950 border border-zinc-800 rounded-xl p-4 text-sm font-mono text-white outline-none focus:border-emerald-500 transition-all"
              />
              <p className="text-[8px] font-bold text-zinc-600 mt-2 uppercase">Encontre este código na aba "Testar Eventos" do Gerenciador de Eventos da Meta.</p>
            </div>
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <button 
              ...
              className={`flex-1 p-4 rounded-xl font-black text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 transition-all ${
                loading ? 'bg-zinc-800 text-zinc-500' : 'bg-emerald-600 hover:bg-emerald-700 text-white shadow-lg shadow-emerald-900/20'
              }`}
            >
            ...
            <a 
              ...
              download
              className="p-4 px-6 bg-amber-600 hover:bg-amber-700 text-white rounded-xl font-black text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 transition-all shadow-lg shadow-amber-900/20"
            >
              <Download size={16} />
              Exportar para GTM
            </a>
      ...
      <div className="bg-zinc-900 p-8 rounded-[3rem] border border-zinc-800 shadow-2xl">
        <div className="flex justify-between items-center mb-8">
          ...
          <button 
            onClick={handleCopy}
            className="p-3 px-6 bg-zinc-800 hover:bg-zinc-700 text-white rounded-xl font-black text-[10px] uppercase tracking-widest flex items-center gap-2 transition-all"
          >
        ...
        <div className="mt-8 p-8 bg-amber-600/5 rounded-[2rem] border border-amber-500/10">
          ...
          <div className="bg-zinc-950 rounded-xl border border-zinc-800 p-4 font-mono text-[11px] text-emerald-400">
            {`onclick="fbq('track', 'Lead');"`}
          </div>
          <p className="text-[10px] font-bold text-zinc-500 mt-4 uppercase">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-zinc-950/50 p-6 rounded-2xl border border-zinc-800/50 flex gap-4">
            ...
            <div>
              <p className="text-[10px] font-black text-zinc-100 uppercase mb-1">Onde Instalar?</p>
          ...
          <div className="bg-zinc-950/50 p-6 rounded-2xl border border-zinc-800/50 flex gap-4">
            ...
            <div>
              <p className="text-[10px] font-black text-zinc-100 uppercase mb-1">Verificação</p>
              <p className="text-[10px] font-bold text-zinc-500 uppercase leading-relaxed">
